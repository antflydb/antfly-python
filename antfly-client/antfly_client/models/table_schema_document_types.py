...
T = TypeVar("T", bound="TableSchemaDocumentTypes")
...
class TableSchemaDocumentTypes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        table_schema_document_types = cls()
        ...
        table_schema_document_types.additional_properties = additional_properties
        return table_schema_document_types
