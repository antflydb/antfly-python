...
T = TypeVar("T", bound="AggregationBucketSubAggregations")


@_attrs_define
class AggregationBucketSubAggregations:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        aggregation_bucket_sub_aggregations = cls()
        ...
        aggregation_bucket_sub_aggregations.additional_properties = additional_properties
        return aggregation_bucket_sub_aggregations
