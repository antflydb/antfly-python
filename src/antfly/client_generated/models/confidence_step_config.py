...
class ConfidenceStepConfig:
    r"""Configuration for confidence assessment. Evaluates answer quality and
    resource relevance. Can use a model calibrated for scoring tasks.

        Attributes:
            enabled (Union[Unset, bool]): Enable confidence scoring Default: False.
            ...
            chain (Union[Unset, list['ChainLink']]): Chain of generators to try in order. Mutually exclusive with
                'generator'.
            context (Union[Unset, str]): Custom guidance for confidence assessment approach Example: Be conservative - only
                give high confidence if resources directly address the question.
    """
