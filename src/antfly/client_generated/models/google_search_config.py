...
from ..models.google_search_config_search_type import GoogleSearchConfigSearchType
from ..models.web_search_provider import WebSearchProvider
from ..types import UNSET, Unset

T = TypeVar("T", bound="GoogleSearchConfig")
...
class GoogleSearchConfig:
    ...
    **Docs:** https://developers.google.com/custom-search/v1/overview
        ...
        Attributes:
            ...
            api_key (Union[Unset, str]): Google API key (or set GOOGLE_CSE_API_KEY env var)
            cse_id (Union[Unset, str]): Custom Search Engine ID (or set GOOGLE_CSE_ID env var)
            search_type (Union[Unset, GoogleSearchConfigSearchType]): Type of search to perform Default:
                GoogleSearchConfigSearchType.WEB.
            date_restrict (Union[Unset, str]): Restrict results by date (e.g., 'd7' for last 7 days, 'm1' for last month)
                Example: m1.
    """
    ...
    cse_id: Union[Unset, str] = UNSET
    search_type: Union[Unset, GoogleSearchConfigSearchType] = GoogleSearchConfigSearchType.WEB
    date_restrict: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cse_id = d.pop("cse_id", UNSET)

        _search_type = d.pop("search_type", UNSET)
        search_type: Union[Unset, GoogleSearchConfigSearchType]
        if isinstance(_search_type, Unset):
            search_type = UNSET
        else:
            search_type = GoogleSearchConfigSearchType(_search_type)

        date_restrict = d.pop("date_restrict", UNSET)

        google_search_config = cls(
            provider=provider,
        ...
        google_search_config.additional_properties = d
        return google_search_config
